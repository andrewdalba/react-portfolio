            ...
            <div className="row">
                <div className="col-sm-12 col-md-6 col-lg-3">
                    <div className="card">
                        ...
                        <div className="card-section">
                            <h4>Stellar Sonic</h4>
                            <p>An exciting interactive social media website to visualize your personal music taste and
                                share it with other users.
                                This site is equipped with a signup/login system and a shoutbox which allows users to
                                interact with each other. </p>
                            <p>Check out the GitHub repository <a href="https://github.com/AndreG303/Stellar-Sonic"
                ...
                <div className="col-sm-12 col-md-6 col-lg-3">
                    <div className="card">
                        ...
                        <div className="card-section">
                            ...
                            <p>Check out the GitHub repository <a
                ...
                <div className="col-sm-12 col-md-6 col-lg-3">
                    <div className="card">
                        ...
                        <div className="card-section">
                            ...
                            <p>A fun timed quiz on a popular videogame. Time is deducted for selecting incorrect
                                answers.</p>
                            <p>Check out the GitHub repository <a
                ...
                <div className="col-sm-12 col-md-6 col-lg-3">
                    <div className="card">
                        ...
                        <div className="card-section">
                            <h4>My Resume</h4>
                            <p id="testing">The resume I use to apply for electrical engineering technology jobs.</p>
                        </div>
                    </div>
                </div>
            </div>
